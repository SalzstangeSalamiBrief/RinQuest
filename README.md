...
## Credits
Thanks to the user Payotz (https://github.com/Payotz) for providing assets from a similar project (https://github.com/Payotz/Nene_Quest). Using this assets reduced the development time, because i had not to create them by myself.
